...
?>
 <div class="modal fade" id="modalRepPregunta" tabindex="-#modalRepPublicacion" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <p>Escoge la razon po la cual quieres notificar esta publicacion</p>
           ...
           <?php
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="causalPre" id="causal" value="<?php echo $c -> getIdCausal() ?>">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="enviarNotificacionPreg">Enviar notificacion</button>
      </div>
    </div>
  </div>
</div>