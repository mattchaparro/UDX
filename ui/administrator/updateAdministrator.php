...
if(isset($_POST['update'])){
	...
	if($_SESSION['entity'] == 'Administrator'){
		...
		$logEstudiante = new LogEstudiante("","Edit Administrator", "Name: " . $name . ";; Last Name: " . $lastName . ";; Email: " . $email . ";; Phone: " . $phone . ";; Mobile: " . $mobile . ";; State: " . $state, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
