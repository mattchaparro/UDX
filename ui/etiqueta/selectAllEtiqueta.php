...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Get All Etiqueta</h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/etiqueta/selectAllEtiqueta.php") ?>&order=nombre&dir=asc'>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/etiqueta/selectAllEtiqueta.php") ?>&order=nombre&dir=desc'>
					...
					if($order != "" && $dir != "") {
						$etiquetas = $etiqueta -> selectAllOrder($order, $dir);
					} else {
						$etiquetas = $etiqueta -> selectAll();
					}
					$counter = 1;
					foreach ($etiquetas as $currentEtiqueta) {
						echo "<tr><td>" . $counter . "</td>";
						echo "<td>" . $currentEtiqueta -> getNombre() . "</td>";
